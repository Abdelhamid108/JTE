...
//
// Contract: checks the version, refuses duplicates, registers the
// promotion. Never rebuilds the application — promotion only ever
// reassigns an already-built, already-scanned, already-pushed image to a
// new environment.
